...
lazy_static::lazy_static! {
    static ref DICT_MONO_CHARS: HashMap<char, MonoChar> = serde_json::from_str(MONO_CHARS_DIST_STR).unwrap();
    static ref DICT_POLY_CHARS: HashMap<char, PolyChar> = serde_json::from_str(POLY_CHARS_DIST_STR).unwrap();
